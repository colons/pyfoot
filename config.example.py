...
# This goes in ~/.pyfoot/config.py by default.
##
# This is the configuration file for your pyfoot.
# Global as well as per network settings go here.
#
# Note: This is a Python 3.2 module, specifically one with one or more dictionaries
# and nothing else. As such, any Python 3.2 code is acceptable here.
# It also must conform to Python's syntax.
#
